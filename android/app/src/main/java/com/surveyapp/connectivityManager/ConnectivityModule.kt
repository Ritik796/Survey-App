package com.surveyapp.connectivityManager
...
class ConnectivityModule(private val reactContext: ReactApplicationContext) :
   ...
   private fun isDeviceLocationHighAccuracy(context: Context): Boolean {
    ...
    @ReactMethod
    fun startMonitoring() {
        Log.d(TAG, "startMonitoring: Connectivity monitoring started")
    ...
    @ReactMethod
    fun stopMonitoring() {
        Log.d(TAG, "stopMonitoring: Connectivity monitoring stopped")
        unregister()
    }
